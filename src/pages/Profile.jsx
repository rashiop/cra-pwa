...
const subscribe = async () => {
  const public_key = 'BCyah9PuDW50e2rdsNtmf5HkhmTJ_XusMQdXzsRu0NH-pzogDrCOYP_EoBCH1uHGJYEg3ZR9kaD8XjIgRcIgUcc'
  ...
  try {
    ...
    console.error('Cant subscribe', ex)
  }
}
        ...
        <div className="container mx-auto min-h-screen">
          <div className="flex flex-col items-center justify-center">
            <div className="w-full md:w-4/12 text-center">
              ...
              <h2 className="text-xl font-semibold mb-1">Udra Uweo Uwawaw</h2>
          ...
          <ul className="max-w-full md:max-w-lg mx-auto">
            ...
            >
              ...
              <span>
                <button onClick={subscribe} className="btn px-7 py-2 min-h-11 bg-pink-500 rounded-xl text-white">
                  Subscribe
                </button>
                {/* <label
                  htmlFor="subscribe"
